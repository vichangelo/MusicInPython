...
def get_name_interface():
    first_note = notes.note_input("\nInput the first note of the "
                                  + "interval, if you may. ")
    second_note = notes.note_input("\nNow input the second note, "
                                   + "please. ")
...
class TestIntervalClass:
    interval_list = [Interval("I"), Interval("III"), Interval("bIII"),
                     Interval("bV"), Interval("IV"), Interval("#V")]
